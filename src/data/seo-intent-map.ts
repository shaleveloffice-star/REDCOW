...
const HE_PAGE_INTENT: Partial<Record<SeoPageId, PageIntentPatch>> = {
      ...
      items: [
        {
          ...
          answer:
            "SO WHAT נמצאת ברחוב אחוזה 96 ברעננה. אם אתם מחפשים המבורגר ברעננה או מסעדה כשרה ברעננה, אפשר לאכול במקום או להזמין משלוח לאזורי החלוקה."
        },
        {
          question: "האם SO WHAT היא מסעדה כשרה ברעננה?",
          answer:
            "כן. SO WHAT היא מסעדה כשרה ברעננה הפועלת תחת כשרות הרבנות. התפריט כשר ומבוסס על חומרי גלם איכותיים."
        },
        {
  ...
  locations: {
    ...
    faq: {
      ...
      items: [
        {
          question: "איפה נמצא סניף SO WHAT ברעננה?",
          answer:
...
const HE_CATEGORY_INTENT: Record<string, CategoryIntentPatch> = {
  "cat-burgers": {
    ...
    bottomContent: joinParagraphs([
      ...
      "מכירים כבר את SO WHAT ברעננה ורוצים את התמונה המלאה על המותג והמיקום? חזרו לדף הבית, או המשיכו לתפריט המלא."
    ]),
    cta: {
      title: "SO WHAT רעננה",
  ...
  "cat-meals": {
    ...
    metaDescription:
      "ארוחת המבורגר של SO WHAT - המבורגר, תוספת ושתייה בארוחה אחת. נוח לארוחת צהריים, לערב או עם חברים.",
    introduction: joinParagraphs([
...
const STORY_SEO_OVERRIDES: Record<string, StorySeoOverride> = {
  "kosher-burger": {
    metaTitle: "המבורגר כשר - הסיפור מאחורי הבשר | SO WHAT",
    metaDescription:
      "כתבה על המבורגר כשר: למה הבשר חשוב, איך אנחנו מכינים, ומה הופך בורגר כשר לחוויה בלי פשרות - מתוך המגזין של SO WHAT."
  },
  "smash-burger": {
    metaTitle: "סמאש בורגר - הצריבה שעושה את ההבדל | SO WHAT",
    metaDescription:
      "מה הופך סמאש בורגר לטוב באמת? על צריבה, בשר טרי ופלנצ׳ה - כתבה מהמגזין של SO WHAT (לא תפריט ההזמנה)."
  }
};
