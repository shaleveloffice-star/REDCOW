...
function hebrewMenuItemOverlay(item: MenuItem): MenuItemDisplayOverlay {
...
function hebrewCategoryOverlay(category: Pick<MenuCategory, "name" | "description">): MenuCategoryDisplayOverlay {
  return {
