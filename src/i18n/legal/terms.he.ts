...
export function getTermsContentHe(): LegalDocument {
  return {
    lastUpdated: "עודכן לאחרונה: 22/07/2026",
    ...
    introBlocks: [
      ...
      {
        type: "paragraph",
        text: "השימוש באתר, לרבות גלישה, ביצוע הזמנה, יצירת קשר, הרשמה למועדון לקוחות, השארת פרטים או שימוש בכל שירות המוצע באתר, מהווה אישור והסכמה מלאה לתנאי תקנון זה ולמדיניות הפרטיות של האתר."
      },
      {
        type: "paragraph",
